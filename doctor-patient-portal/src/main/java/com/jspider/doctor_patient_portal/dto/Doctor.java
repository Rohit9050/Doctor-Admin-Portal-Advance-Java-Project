package com.jspider.doctor_patient_portal.dto;
...
public class Doctor {
	...
	public String toString() {
		return "Doctor [id=" + id + ", fullName=" + fullName + ", dateOfBirth=" + dateOfBirth + ", qualification="
				+ qualification + ", specialist=" + specialist + ", email=" + email + ", phone=" + phone + ", password="
				+ password + "]";
	}
