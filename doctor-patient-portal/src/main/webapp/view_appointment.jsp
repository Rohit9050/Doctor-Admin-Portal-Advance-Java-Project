<%@page import="com.jspider.doctor_patient_portal.connection.DBConnection"%>
<%@page import="com.jspider.doctor_patient_portal.dto.Doctor"%>
<%@page import="com.jspider.doctor_patient_portal.dto.Appointment"%>
<%@page import="java.util.List"%>
<%@page import="com.jspider.doctor_patient_portal.dao.AppointmentDAO"%>
<%@page import="com.jspider.doctor_patient_portal.dao.DoctorDAO"%>
<%@page import="com.jspider.doctor_patient_portal.dto.User"%>
