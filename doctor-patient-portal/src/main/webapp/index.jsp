...
<%@ page import="com.jspider.doctor_patient_portal.connection.*"%>
...
<body>
	...
	<div id="carouselExampleIndicators" class="carousel slide"
		...
		<div class="carousel-inner">
			...
			<div class="carousel-item">
				<img src="img/hospital3.jpg" style="height: 50vh"
				...
				<div class="row">
					<div class="col-md-6">
						<div class="card my-card">
							<div class="card-body">
								<p class="fs-5 myP-color">2000+ Healing Hands</p>
					...
					<div class="col-md-6">
						<div class="card my-card">
							<div class="card-body">
								...
								<p>Medi-Hospitals has been the pioneer in bringing
						...
						<div class="card my-card">
							<div class="card-body">
								...
								<p>Leveraging its vast medical expertise & technological
									advantage, Medi-Hospitals has consistently delivered best in
									class clinical outcomes.</p>
							</div>
						</div>
					</div>
					...
					<div class="col-md-6 mt-2">
						<div class="card my-card">
							<div class="card-body">
								<p class="fs-5 myP-color">100+ Pharmacies</p>
								<p>MediTrust Pharmacy is our first, largest, and most
									trusted branded pharmacy network, with over 50 plus outlets
									comprehensively covering the entire nation.</p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="col-md-3">
				<div class="card my-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr. Alice</p>
			...
			<div class="col-md-3">
				<div class="card my-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr. Antonia</p>
						<p class="fs-7">(Chief Doctor)</p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-3">
				<div class="card my-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr. Malia</p>
						<p class="fs-7">(Dean)</p>
					</div>
				</div>
			</div>
